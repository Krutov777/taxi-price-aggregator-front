<template>
  <div class="col-md-12">
    <div class="card card-container">
      ...
      <form name="form" @submit.prevent="handleRegister">
        <div v-if="!successful">
          <div class="form-group">
            ...
            <small 
              class="text-danger"
              v-else-if="$v.username.$dirty && !$v.username.minLength || !$v.username.maxLength"
            >
            Логин должен быть в пределах от {{$v.username.$params.minLength.min}} до {{$v.username.$params.maxLength.max}} символов. Сейчас он {{username.length}}
            </small>
          </div>
          <div class="form-group">
        ...
        <div class="form-group">
          ...
          >
            Пароль должен быть в пределах от {{$v.repeatPassword.$params.minLength.min}} до {{$v.repeatPassword.$params.maxLength.max}} символов. Сейчас он {{repeatPassword.length}}
          </small>
          <small 
          class="text-danger"
        ...
        <div class="form-group">
          ...
          >
          Имя должено быть в пределах от {{$v.firstName.$params.minLength.min}} до {{$v.firstName.$params.maxLength.max}} символов. Сейчас оно {{firstName.length}}
          </small>
        </div>
        <div class="form-group">
          ...
          <small 
            class="text-danger"
            v-else-if="$v.surname.$dirty && !$v.surname.minLength || !$v.surname.maxLength"
          >
          Фамилия должена быть в пределах от {{$v.surname.$params.minLength.min}} до {{$v.surname.$params.maxLength.max}} символов. Сейчас она {{surname.length}}
          </small>
        </div>
        <div class="form-group">
      ...
      >Пользователь с таким email или логином уже существует</div>
    </div>
  </div>
</template>
